...
const { DECIMAL_PLACES, INITIAL_TOTAL, PERCENTAGE_MULTIPLIER } =
  REVIEW_FORM_CONFIG;
...
const ReviewFormContent = ({
  ...
  const ratingRange = Array.from(
    { length: STAR_MAX_RATING },
    (_, i) => STAR_MAX_RATING - i,
  );
    ...
    <>
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-2">
          <StarRating rating={STAR_MAX_RATING} size={STAR_LARGE} />
        ...
        <div className="flex flex-wrap justify-center items-center gap-[6px]">
          ...
          <p className="text-base font-medium leading-none">件のレビュー</p>
        </div>
      </div>
      ...
      {productReviewStats && (
        <div className="grid gap-2 justify-center">
          {ratingRange.map((rating: number) => {
            ...
            return (
              <div key={rating} className="flex items-center gap-4 w-full">
                <div className="flex items-center gap-1">
                  ...
                  ></Image>
                  <span className="text-base font-semibold leading-none font-poppins min-w-3 text-center">
                    {rating}
                  </span>
                </div>
