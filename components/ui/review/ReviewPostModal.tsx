            ...
            <div className="modal-container">
              ...
              >
                <div className="overflow-y-auto flex-1 pr-4 md:pr-8 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-sub [&::-webkit-scrollbar-thumb]:rounded-full">
                  ...
                  >
                    <div>
                      <label className="review-form-label">評価</label>
                    ...
                    <div>
                      <FormLabel name="textarea" label="レビュー内容" />
                      <FormTextarea
                        name="textarea"
                        value={textarea}
                    ...
                    <div>
                      <p className="text-[13px] md:text-sm leading-[24px] font-medium text-center mb-4 mt-3 md:mb-6">
                        ※送信されたレビューはストアオーナーの承認後に表示されます
                      </p>
