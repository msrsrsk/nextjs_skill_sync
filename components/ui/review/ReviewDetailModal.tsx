...
import StatusBadge from "@/components/common/labels/StatusBadge";
                ...
                <div className="md:flex md:justify-between md:items-center">
                  {hasImages && (
                    <div className="mb-5 md:mb-0 w-full md:w-[53%] pr-3 md:pr-0">
                      ...
                      <Slider
                        ...
                        {...reviewMainSliderSettings}
                      >
                        {image_urls.map((image: string, index: number) =>
                  ...
                  >
                    ...
                    <div className="review-list-metabox">
                      <StarRating rating={rating} type={STAR_COLOR} />
                      {is_priority && <StatusBadge status="Pickup" />}
                    </div>
                  ...
                  <button
                    ...
                    aria-label="モーダルを閉じる"
                  >
                    <CircleX className="w-[22px] h-[22px] text-foreground" />
                  </button>
                </div>
              </div>
            </motion.div>
          </div>
          <Overlay isActive={modalActive} setActive={setModalActive} />
        </div>
      )}
    </AnimatePresence>
  );
