...
const VerifyContentWithStatus = ({
  ...
  const { verificationStatus, errorMessage } = useAccountVerification({
    verifyEmailType,
  });
        ...
        {verificationStatus === STATUS_SUCCESS && (
          <>
            <div className="mt-6 mb-8 md:my-10 relative flex justify-center">
              ...
              <LottieAnimation
                src={CONGRATS_LOTTIE_PATH}
                customClass="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
              />
            </div>

            <div className="max-w-sm mx-auto relative z-10">
              <p className="attention-text text-center">{successDescription}</p>
              <LinkButtonPrimary
