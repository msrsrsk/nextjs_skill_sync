...
const CreateAccountContent = ({
  ...
  return (
    <>
      <PageTitle title="Create Account" customClass="mt-6 mb-8 md:my-10" />
      ...
      <div className="max-w-sm mx-auto">
        <form action={createFormAction}>
          <div className="form-box">
            <div>
              <FormLabel name="lastname" label="お名前" />
            ...
            <div>
              <FormLabel name="email" label="メールアドレス" />
              <FormInput
                name="email"
                type="text"
                value={email}
            ...
            <div>
              <FormLabel name="password" label="パスワード" />
              <FormPassword
                value={password}
...
const CreateAccountButton = ({ isValid }: { isValid: boolean }) => {
  ...
  return (
    ...
    >
      <PendingContent pending={pending} text="アカウントを作成" />
    </EventButtonPrimary>
  );
};
