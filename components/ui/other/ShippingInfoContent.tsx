      ...
      <div className="max-w-xl mx-auto grid gap-6 md:gap-10">
        <div className="account-info-box">
          ...
          <div className="account-address-dlbox">
            {optimisticDefaultAddress ? (
              ...
              <p className="order-no-data w-full">まだデータがありません</p>
            )}
          </div>
        </div>
        ...
        <div className="account-info-box">
          ...
          {optimisticOtherAddresses.length === 0 ? (
            <>
              <p className="order-no-data">まだデータがありません</p>
                  ...
                  <div className="account-address-dlbox">
                    ...
                    <div className="account-address-btn">
                      <button
                        ...
                        onClick={() =>
                          handleSetDefaultCheck(shippingAddress.id)
                        }
                      >
                        お届け先として設定
                        <Truck
                      ...
                      <div className="flex items-center gap-[10px] md:gap-[12px]">
                        <EventButtonSecondary
                          ...
                          text={BUTTON_JA}
                          onClick={() =>
                            handleRemoveAddressId(shippingAddress.id)
                          }
                        >
                          削除
                        </EventButtonSecondary>
                        <EventButtonPrimary
                          ...
                          text={BUTTON_JA}
                          onClick={() =>
                            handleEditAddressId(shippingAddress.id)
                          }
                        >
                          編集
                        </EventButtonPrimary>
