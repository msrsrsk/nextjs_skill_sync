...
const DeleteAccountContent = ({
  ...
  const { agreements, handleAgreementChange, isAllChecked, resetAgreements } =
    useAgreements({ checkList: deleteAccountCheckList });

  const { loading, error, timestamp, deleteAccount } = useDeleteAccount();
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <p className="legal-subtitle">退会手続き</p>
