...
const CollectionFilterBox = ({
  ...
  const { isStock, setIsStock, priceRange, handlePriceChange, handleSave } =
    useCollectionFilter({
      priceBounds,
  ...
  return (
    <div className={`filter-box${collectionFilterOpen ? " is-active" : ""}`}>
      <form className="filter-inner" onSubmit={handleSave}>
        ...
        <div className="filter-stock-box">
          ...
          <div className="filter-stock-content">
            <button
              className={`filter-stock-button${!isStock ? " is-active" : ""}`}
