...
const HeaderContent = ({
  ...
  return (
    <>
      <header
        ref={headerRef}
        className={`header${isOpen ? " bg-background" : " grass-no-gradient"}${
          isPrintPage ? " hidden" : ""
        }`}
      >
        <div className="header-wrapper">
          <div className="header-inner">
            ...
            <NavIcons setDrawerOpen={setDrawerOpen} />
          </div>
        ...
        <Suspense fallback={null}>
          {isPriceBoundsReady && (
            <CollectionFilterBox priceBounds={priceBounds} />
          )}
          <CollectionSortBox />
        </Suspense>
      </header>
