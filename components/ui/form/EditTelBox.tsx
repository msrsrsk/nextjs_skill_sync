...
const EditTelBox = ({
  ...
  const { tel, setTel, errorList, isValid, handleTelChange, validateTel } =
    useTelValidation();
  ...
  return (
    <Modal modalActive={modalActive} setModalActive={setModalActive}>
      ...
      <form className="pl-[2px]">
        ...
        <SaveButton isValid={isValid} handleFormSubmit={handleFormSubmit} />
      </form>
    </Modal>
  );
};
