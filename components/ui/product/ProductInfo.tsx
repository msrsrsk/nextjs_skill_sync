...
const ProductInfo = ({
  ...
  const { category, product_sales, product_details, product_relations } =
    product;

  const sold_count = product_sales?.sold_count;
  const optimal_syncs_required_id =
    product_relations?.optimal_syncs_required_id;
