    ...
    return (
      <div className="mb-4 md:mb-0">
        <p
          ...
          className={`price-text${salePrice ? " text-tag-default" : ""}`}
        >
  ...
  if (isList || isDetail) {
    return (
      <div className={`${isDetail ? "mb-4" : ""}`}>
        {!isSoldOut && salePrice && (
          <div className={`${isDetail ? "mb-3" : "mb-1"}`} aria-hidden="true">
            <span
            ...
            <span
              className={`price-text line-through${
        ...
        >
          ...
          >
            ...
            <span
              className={`price-text${isList ? " text-base" : " text-2xl"}`}
              aria-hidden="true"
            >
              {!isSoldOut && salePrice
