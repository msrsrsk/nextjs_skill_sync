...
const AccountInfoModal = ({
  ...
  const isValid =
    displayNameIsValid && postalCodeIsValid && addressLine1IsValid;
    ...
    <Modal modalActive={modalActive} setModalActive={setModalActive}>
      ...
      <form className="pl-[2px]">
        <div className="form-box">
          ...
          <div>
            <FormLabel name="postal_code" label="郵便番号" />
            <FormInput
              name="postal_code"
              type="text"
              value={postalCode}
          ...
          <div>
            <FormLabel name="state" label="都道府県" />
            <FormSelect
              name="state"
              value={selectedState}
              options={formStates}
          ...
          <div>
            <FormLabel name="address_line1" label="市区町村・番地" />
            <FormInput
              name="address_line1"
              type="text"
              value={addressLine1}
          ...
          <div>
            <FormLabel name="address_line2" label="建物名・部屋番号" />
            <FormInput
              name="address_line2"
              type="text"
              value={addressLine2}
        ...
        <SubmitButton isValid={isValid} handleFormSubmit={handleFormSubmit} />
      </form>
    </Modal>
  );
};

const SubmitButton = ({ isValid, handleFormSubmit }: EditButtonProps) => {
