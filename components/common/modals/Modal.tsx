          ...
          <div className="modal-container">
            ...
            >
              <div
                className={`${
                  isMedium
                    ? "overflow-y-auto flex-1 pr-4 md:pr-8 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-sub [&::-webkit-scrollbar-thumb]:rounded-full"
                    : ""
                }`}
              >
                {children}
