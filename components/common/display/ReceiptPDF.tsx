...
const ReceiptPDF = ({
  ...
  const receiptNumber =
    isSubscription && subscriptionPaymentId
      ? subscriptionPaymentId
      : order_number;
  ...
  return (
    <Document style={tw("leading-[150%] tracking-wide font-zen")}>
      <Page size="A4" style={tw("py-8 px-6")}>
        ...
        <View
          style={tw(
            "max-w-[240px] w-full mx-auto border-b border-foreground mb-3",
          )}
        >
        ...
        <View
          style={tw("max-w-[240px] w-full mx-auto bg-accent py-[2px] mb-2")}
        >
        ...
        <View style={tw("flex flex-row gap-6 mb-8")}>
          <View style={tw("max-w-[254px] w-full mr-5")}>
            ...
            <Text style={tw("text-base font-meduim")}>{delivery_name} 様</Text>
            <Text style={tw("text-base font-meduim")}>
              支払い方法: {formatPaymentCardBrand(payment_method)}
            </Text>
          </View>
          <View style={tw("max-w-[254px] w-full ml-5 relative")}>
            <Text style={tw("text-base font-meduim")}>SKILL SYNC</Text>
            <Text style={tw("text-base font-meduim")}>〒000-0000</Text>
            <Text style={tw("text-base font-meduim")}>
              北海道未来市仮想区1-2-3
            </Text>
            <Text style={tw("text-base font-meduim")}>
        ...
        <View>
          <View style={tw("flex flex-row")}>
            <Text
              style={tw(
                "bg-accent text-sm font-bold pt-1 pb-2 px-2 max-w-[191px] w-full text-center border border-main min-h-[23px]",
              )}
            >
              商品名
            </Text>
            <Text
              style={tw(
                "bg-accent text-sm font-bold pt-1 pb-2 px-2 max-w-[40px] w-full text-center border-t border-r border-b border-main min-h-[23px]",
              )}
            >
              税率
            </Text>
            <Text
              style={tw(
                "bg-accent text-sm font-bold pt-1 pb-2 px-2 max-w-[64px] w-full text-center border-t border-r border-b border-main min-h-[23px]",
              )}
            >
              単価
            </Text>
            <Text
              style={tw(
                "bg-accent text-sm font-bold pt-1 pb-2 px-2 max-w-[48px] w-full text-center border-t border-r border-b border-main min-h-[23px]",
              )}
            >
              数量
            </Text>
            <Text
              style={tw(
                "bg-accent text-sm font-bold pt-1 pb-2 px-2 max-w-[100px] w-full text-center border-t border-r border-b border-main min-h-[23px]",
              )}
            >
              金額
            </Text>
            <Text
              style={tw(
                "bg-accent text-sm font-bold pt-1 pb-2 px-2 max-w-[114px] w-full text-center border-t border-r border-b border-main min-h-[23px]",
              )}
            >
              備考
            </Text>
        ...
        {order_items.map((item: OrderHistorySelectFields) => {
          const { product, quantity, unit_price, order_item_subscriptions } =
            item;

          const remarks = order_item_subscriptions?.remarks;
          ...
          return (
            <View key={item.id}>
              <View style={tw("flex flex-row")}>
                <Text
                  style={tw(
                    "text-sm font-meduim pt-1 pb-2 px-2 max-w-[191px] w-full border-l border-r border-b border-main min-h-[23px]",
                  )}
                >
                  {product.title}
                  {isSubscription && "（サブスクリプション）"}
                </Text>
                <Text
                  style={tw(
                    "text-sm font-meduim pt-1 pb-2 px-2 max-w-[40px] w-full text-center border-r border-b border-main min-h-[23px]",
                  )}
                >
                  {TAX_RATE_10 * 100}%
                </Text>
                <Text
                  style={tw(
                    "text-sm font-meduim pt-1 pb-2 px-2 max-w-[64px] w-full text-right border-r border-b border-main min-h-[23px]",
                  )}
                >
                ...
                <Text
                  style={tw(
                    "text-sm font-meduim pt-1 pb-2 px-2 max-w-[48px] w-full text-right border-r border-b border-main min-h-[23px]",
                  )}
                >
                  {quantity}
                </Text>
                <Text
                  style={tw(
                    "text-sm font-meduim pt-1 pb-2 px-2 max-w-[100px] w-full text-right border-r border-b border-main min-h-[23px]",
                  )}
                >
                ...
                <Text
                  style={tw(
                    "text-sm font-meduim pt-1 pb-2 px-2 max-w-[114px] w-full border-r border-b border-main min-h-[23px]",
                  )}
                >
                  {remarks && remarks}
                  <br />
        ...
        <View>
          <View style={tw("flex flex-row")}>
            <Text
              style={tw(
                "text-sm font-bold pt-1 pb-2 px-2 max-w-[343px] w-full text-center border-l border-r border-b border-main min-h-[23px]",
              )}
            ></Text>
            <Text
              style={tw(
                "text-sm font-bold pt-1 pb-2 px-2 max-w-[100px] w-full text-right border-r border-b border-main min-h-[23px]",
              )}
            ></Text>
            <Text
              style={tw(
                "text-sm font-meduim pt-1 pb-2 px-2 max-w-[114px] w-full text-right border-r border-b border-main min-h-[23px]",
              )}
            ></Text>
          </View>
        </View>
        ...
        <View>
          <View style={tw("flex flex-row")}>
            <Text
              style={tw(
                "text-xs font-bold pt-1 pb-2 px-2 max-w-[343px] w-full text-center border-l border-r border-b border-main min-h-[23px]",
              )}
            ></Text>
            <Text
              style={tw(
                "text-xs font-bold pt-1 pb-2 px-2 max-w-[100px] w-full text-right border-r border-b border-main min-h-[23px]",
              )}
            >
            ...
            <Text
              style={tw(
                "text-xs font-meduim pt-1 pb-2 px-2 max-w-[114px] w-full text-right border-r border-b border-main min-h-[23px]",
              )}
            >
              ¥0
            </Text>
        ...
        <View>
          <View style={tw("flex flex-row")}>
            <Text
              style={tw(
                "text-sm font-bold pt-1 pb-2 px-2 max-w-[343px] w-full text-center border-l border-r border-b border-main",
              )}
            ></Text>
            <Text
              style={tw(
                "text-sm font-bold pt-1 pb-2 px-2 max-w-[100px] w-full text-right border-r border-b border-main",
              )}
            >
              合計
            </Text>
            <Text
              style={tw(
                "text-sm font-meduim pt-1 pb-2 px-2 max-w-[114px] w-full text-right border-r border-b border-main",
              )}
            >
              ¥{formatNumber(total_amount)}
            </Text>
