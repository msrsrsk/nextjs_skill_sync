      ...
      <div className="footer-wrapper">
          ...
          <div className="footer-navlink-wrapper">
            {footerLinks.map((links) => (
              <div key={links.label} className="footer-navlink-box">
                <h2 className="footer-navlink-title" aria-label={links.label}>
                  <span aria-hidden="true">&lt; {links.label} &gt;</span>
                </h2>
                <ul role="list">
                  {links.children &&
                    links.children.map((link) => (
                      <li key={link.label} className="footer-navlink-item">
                        <Link href={link.href} className="footer-navlink-link">
                          {link.label}
                        </Link>
                      </li>
                    ))}
        ...
        <div className="footer-legal-wrapper">
          <ul role="list" className="footer-legal-linkbox">
            {legalLinks.map((link) => (
              <li key={link.label} className="footer-legal-linklist">
