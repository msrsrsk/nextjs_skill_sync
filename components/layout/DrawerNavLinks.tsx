...
const DrawerNavLinks = ({
  ...
  return (
    <ul role="list" className="drawer-navlink-wrapper">
              ...
              <>
                {links.label === "Another World" ? (
                  pathname === HOME_PATH ? (
                    ...
                    >
                      <span className="drawer-title">{links.label}</span>
                    </Scroll>
                  ) : (
                    <Link
                  ...
                  <Link href={links.href} className="drawer-navlink-titlebox">
                    {links.label}
                  </Link>
                )}
              </>
              ...
              >
                {links.children &&
                  links.children.map((link) => (
                    <li key={link.label} className="drawer-navlink-item">
                      <Link
                        href={link.href}
