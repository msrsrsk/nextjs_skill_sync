...
const Drawer = ({ drawerOpen, setDrawerOpen, headerHeight }: DrawerProps) => {
  ...
  return (
    <>
      {drawerOpen && (
        <div
          className={`fixed w-full h-screen inset-0 bg-background z-[999] flex flex-col px-5 py-[64px] overflow-auto transition-opacity duration-300`}
        >
          <button
          ...
          <Link href={HOME_PATH} className="mx-auto inline-block mb-6">
            <Image
