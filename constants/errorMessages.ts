...
export const ERROR_MESSAGES = {
  ...
  PRODUCT_ERROR: {
    ...
    STOCK_WEBHOOK_PROCESS_FAILED:
      "商品在庫のWebhook処理中にエラーが発生しました。",
    STRIPE_WEBHOOK_PROCESS_FAILED:
      "Stripeデータ作成のWebhook処理中にエラーが発生しました。",
  },
  ...
  REVIEW_ERROR: {
    ...
    WEBHOOK_INSERT_PROCESS_FAILED:
      "レビュー作成時のWebhook処理中にエラーが発生しました。",
    WEBHOOK_DELETE_FAILED: "レビュー削除時のデータが見つかりませんでした。",
    WEBHOOK_DELETE_PROCESS_FAILED:
      "レビュー削除時のWebhook処理中にエラーが発生しました。",
  },
  ...
  CHAT_ERROR: {
    ...
    OPENAI_EMBEDDING_MODEL_NOT_SET: `OpenAIの埋め込みモデルが設定されていません。`,
  ...
  EMAIL_ERROR: {
    ...
    SUBSCRIPTION_PAYMENT_REQUEST_SEND_FAILED:
      "サブスクリプションのお支払いのお願いのメールの送信に失敗しました",
    EMAIL_BASE_URL_MISSING:
      "有効なURLが見つからないため、メールの送信に失敗しました。",
    EMAIL_TOKEN_MISSING:
      "トークンが見つからないため、メールの送信に失敗しました。",
  },
  ...
  CLOUDFLARE_ERROR: {
    ...
    MISSING_DATA: `ストレージへの画像アップロードに必要な情報が不足しています。${RETRY}`,
