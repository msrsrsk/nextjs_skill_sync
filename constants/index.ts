...
export const SITE_MAP = {
  ...
  CART_COUNT_API_PATH: "/api/cart/count",
  PRODUCTS_API_PATH: "/api/product",
  PRICE_BOUNDS_API_PATH: "/api/product/price-bounds",
...
// チャット履歴の初期メッセージ
export const CHAT_HISTORY_INITIAL_MESSAGE =
  "何かお困りごと・ご質問はございますか？\nご用件を入力してください。";
...
export const CHAT_CONFIG = {
  ...
  DEFAULT_HUMAN_RESPONSE:
    "担当者に確認中です。回答までしばらくお待ちください。（※現在このサイトは運用していないため、回答はありません）",
