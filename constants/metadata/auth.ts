...
export const ACCOUNT_METADATA = {
  CREATE_ACCOUNT_VERIFY: {
    title: "アカウントの作成完了",
    description:
      "アカウントの作成が完了しました。ログインをしてからアカウントページにアクセスしてください。",
  ...
  CREATE_ACCOUNT: {
    title: "アカウントの作成",
    description:
      "新しいアカウントを作成します。お名前・メールアドレス・パスワードを入力の上、「アカウントを作成」ボタンをクリックしてください。",
  ...
  DELETE_ACCOUNT_PUBLIC: {
    title: "退会手続き完了",
    description:
      "アカウントの退会手続きが完了しました。またの再会をお待ちしております。",
  ...
  LOGIN: {
    title: "ログイン",
    description:
      "メールアドレス・パスワードを入力の上、「ログイン」ボタンをクリックしてください。",
    url: LOGIN_PATH,
    robots: {
      index: false,
      follow: false,
  ...
  RESET_PASSWORD_VERIFY: {
    title: "パスワードの変更完了",
    description:
      "パスワードの変更が完了しました。ログインをしてからアカウントページにアクセスしてください。",
  ...
  RESET_PASSWORD: {
    title: "パスワードの変更",
    description:
      "ご登録のメールアドレスを入力してください。パスワードの再設定メールを送信いたします。",
