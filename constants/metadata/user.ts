...
export const USER_METADATA = {
  ...
  DELETE_ACCOUNT_PRIVATE: {
    title: "退会手続き",
    description:
      "アカウントの退会手続きページです。退会手続きの内容をご確認の上、退会手続きを行ってください。",
  ...
  SUBSCRIPTION_HISTORY: {
    title: "サブスクリプション履歴一覧",
    description:
      "お客様のサブスクリプションの履歴一覧を確認することができます。",
  ...
  SUPPORT_CHAT: {
    title: "サポートチャット",
    description:
      "チャットのやり取りができるページです。毎月1日に過去のチャットデータは自動的に削除されます。",
  ...
  ACCOUNT: {
    title: "アカウント",
    description:
      "お客様の購入履歴やお気に入りリスト、各登録情報を確認することができます。",
    url: ACCOUNT_PATH,
    robots: {
      index: false,
      follow: false,
