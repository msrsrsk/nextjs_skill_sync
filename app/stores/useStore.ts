...
export const useCollectionFilterStore = create<CollectionFilterState>()(
  (set) => ({
    collectionFilterOpen: false,
    setCollectionFilterOpen: (value: boolean) =>
      set({ collectionFilterOpen: value }),
  }),
);
...
export const useSubscriptionPurchaseTypeStore =
  create<SubscriptionPurchaseTypeState>()((set) => ({
    subscriptionPurchaseType: SUBSCRIPTION,
    setSubscriptionPurchaseType: (value: SubscriptionPurchaseType) =>
      set({ subscriptionPurchaseType: value }),
  }));

export const useSelectedSubscriptionOptionStore =
  create<SelectedSubscriptionOptionState>()((set) => ({
    selectedSubscriptionOption: null,
    setSelectedSubscriptionOption: (value: SubscriptionOption | null) =>
      set({ selectedSubscriptionOption: value }),
  }));
