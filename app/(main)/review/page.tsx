...
const PublicReviewListPage = ({ searchParams }: SearchParamsWithQuery) => {
  ...
  return (
    <>
      ...
      <div className="c-container-page">
        <PageTitle title="Review" customClass="mt-6 mb-2 md:mt-10 md:mb-4" />

        <Suspense fallback={<LoadingSpinner />}>
          <ReviewListPageWrapper page={page} query={query} isPrivate={false} />
        </Suspense>
      </div>
    </>
  );
