  ...
  return (
    <>
      ...
      <div className="c-container-page">
        <PageTitle title="Tokushoho" customClass="mt-6 mb-3 md:mt-10 md:mb-4" />

        <div className="max-w-xl mx-auto">
          <p className="legal-subtitle">特定商法取引法に基づく表記</p>
          ...
          <dl className="legal-table">
            ...
            <dt>商品代金以外の付帯費用</dt>
            <dd>
              10個未満のスキルの購入：配送料として別途{SHIPPING_FEE_250}
              円（税込）
              <br />
              10個以上のスキルの購入：配送料無料
              <br />
            ...
            <dt>代金の支払方法</dt>
            <dd>
              各種クレジットカード：ご利用のクレジットカード会社のご請求時
            </dd>
            ...
            <dt>継続課金の解約</dt>
            <dd>
              サブスクリプションの解約は、ご利用開始から最低
              {SUBSCRIPTION_CANCEL_THRESHOLD}ヶ月間は解約できません。
              <br />
              {SUBSCRIPTION_CANCEL_THRESHOLD}
              ヶ月経過後は、マイページの「サブスクリプションの詳細」ページから解約可能です。
              <br />
            ...
            <dt>継続課金の支払い方法</dt>
            <dd>
              初回登録時にご指定いただいたクレジットカードから自動引き落とし
              <br />
            </dd>

            <dt>継続課金の配送料</dt>
            <dd>配送料として別途{SHIPPING_FEE_250}円（税込）がかかります。</dd>
