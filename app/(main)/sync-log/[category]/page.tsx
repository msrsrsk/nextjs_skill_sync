    ...
    <>
      ...
      <div className="c-container-page-overflow">
        ...
        <Suspense fallback={<LoadingSpinner />}>
          <SyncLogCategoryWrapper page={page} category={category} />
        </Suspense>
      </div>
    </>
  );
...
const SyncLogCategoryWrapper = async ({
  ...
  const normalizedCategory =
    category === SYNC_ALL.toLowerCase() ? SYNC_ALL : category;
  ...
  return (
    <>
      <SyncLogContent categoryData={data} categoryType={category || SYNC_ALL} />
    </>
  );
};
