...
const SignInPage = ({
  ...
  const { signInSuccess, errorMessage, timestamp, SignInFormAction } =
  ...
  useEffect(() => {
    ...
    if (
      redirectTo &&
      (redirectTo.includes("cart") || redirectTo.includes("book-mark"))
    ) {
  ...
  return (
    <>
      ...
      <div className="c-container-page">
        <PageTitle title="Login" customClass="mt-6 mb-8 md:my-10" />
