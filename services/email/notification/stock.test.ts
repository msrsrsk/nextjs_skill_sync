...
describe("receiveStockNotificationEmail", () => {
  ...
  it("should send stock notification email successfully", async () => {
    ...
    const result = await receiveStockNotificationEmail(
      mockProductNotificationData as NotificationWithDetails,
    );
  ...
  it("should return error when relatedData is null", async () => {
    ...
    const result = await receiveStockNotificationEmail(
      notificationWithNullData as NotificationWithDetails,
    );
  ...
  it("should handle Resend send error", async () => {
    vi.mocked(stockNotificationEmailTemplate).mockReturnValue(
      "<html>Template</html>",
    );
  ...
  it("should return error when record is null", async () => {
    const result = await receiveStockNotificationEmail(
      null as unknown as NotificationWithDetails,
    );
