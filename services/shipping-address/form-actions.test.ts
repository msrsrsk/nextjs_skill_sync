...
const getMockUpdateStripeAndShippingAddress = async () => {
  const { updateStripeAndShippingAddress } =
    await import("@/services/shipping-address/actions");
...
describe("updateDefaultShippingAddressAction", () => {
  ...
  it("should update default shipping address successfully", async () => {
    ...
    const updateStripeAndShippingAddress =
      await getMockUpdateStripeAndShippingAddress();
    ...
    const result = await updateDefaultShippingAddressAction(
      prevState,
      mockFormData,
    );
  ...
  it("should return error when updateStripeAndShippingAddress throws exception", async () => {
    ...
    updateStripeAndShippingAddress.mockRejectedValue(
