...
describe("extractSyncLogList", () => {
  ...
  it("should extract category name correctly", () => {
    const testCases = [
      {
        link: "/category/explorer/sample-product",
        expectedCategory: EXPLORER_TAG,
      },
      {
        link: "/category/creative/sample-product",
        expectedCategory: CREATIVE_TAG,
      },
  ...
  it("should extract data for different product names", () => {
    const testCases = [
      ...
      {
        link: "/category/active/multi-word-product-name",
        expected: "Multi Word Product Name",
      },
      { link: "/category/active/single", expected: "Single" },
      {
        link: "/category/active/very-long-product-name-with-many-words",
        expected: "Very Long Product Name With Many Words",
      },
    ];
  ...
  it("should handle invalid or malformed URLs", () => {
    const testCases = [
      ...
      {
        link: "/category/",
        expected: { imageUrl: "", categoryName: ACTIVE_TAG, productName: "" },
      },
    ];
