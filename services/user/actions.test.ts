...
const getMockGetUserImageFilePathWithTransaction = async () => {
  const { getUserImageFilePathWithTransaction } =
...
describe("createUser", () => {
  ...
  it("should return failure when create user exception occurs", async () => {
    mockCreateUserWithTransaction.mockRejectedValue(
...
describe("deleteUserAccount", () => {
  ...
  it("should delete user account successfully", async () => {
    const mockGetUserImageFilePathWithTransaction =
      await getMockGetUserImageFilePathWithTransaction();
