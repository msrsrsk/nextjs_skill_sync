...
describe("getRecurringConfig", () => {
  ...
  it("should format known intervals correctly", () => {
    const testCases = [
      ...
      {
        input: INTERVAL_3MONTH,
        expected: { interval: "month", interval_count: THRESHOLD_3MONTH },
      },
      {
        input: INTERVAL_6MONTH,
        expected: { interval: "month", interval_count: THRESHOLD_6MONTH },
      },
