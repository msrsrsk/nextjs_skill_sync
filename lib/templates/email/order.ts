                    ...
                    >
                        ...
                        <tr>
                            <td style="padding: 10px 20px; font-size: 16px; text-align: center; background-color: #f0f0f0; border-radius: 4px; margin-bottom: 16px;">
                                <span style="font-size: 16px; font-weight: bold;">ご注文内容</span>
                            </td>
                        </tr>

                        <tr>
                            <td style="padding-top: 16px; font-size: 14px;">
                                注文番号：${formatOrderNumber(orderNumber)}<br>
                                注文日時：${formattedOrderDate}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 20px 0;">
                                ...
                                >
                                    <tr style="display: flex; flex-wrap: wrap; align-items: center;">
                                        <td width="120" style="font-size: 14px; vertical-align: top;">
                                            お届け先
                                        </td>
                            ...
                            <td style="padding: 20px 0;">
                                ...
                                >
                                    <tr style="display: flex; flex-wrap: wrap; align-items: center;">
                                        ...
                                        <td style="font-size: 14px;">${getPaymentErrorDetails(errorType)}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
