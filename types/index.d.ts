...
declare global {
  ...
  type ButtonTextType =
    (typeof BUTTON_TEXT_TYPES)[keyof typeof BUTTON_TEXT_TYPES];
  type ButtonPositionType =
    (typeof BUTTON_POSITIONS)[keyof typeof BUTTON_POSITIONS];
  type ButtonType = (typeof BUTTON_TYPES)[keyof typeof BUTTON_TYPES];
  type ButtonVariantType =
    (typeof BUTTON_VARIANTS)[keyof typeof BUTTON_VARIANTS];
  type UnderlineLinkPositionType =
    (typeof UNDERLINE_LINK_POSITIONS)[keyof typeof UNDERLINE_LINK_POSITIONS];
  ...
  type FileStatusType =
    (typeof FILE_STATUS_TYPES)[keyof typeof FILE_STATUS_TYPES];
  type ErrorMessagePositionType =
    (typeof ERROR_MESSAGE_POSITIONS)[keyof typeof ERROR_MESSAGE_POSITIONS];
  ...
  type LoadingSpinnerSizeType =
    (typeof LOADING_SPINNER_SIZES)[keyof typeof LOADING_SPINNER_SIZES];
  type DateFormatType =
    (typeof DATE_FORMAT_TYPES)[keyof typeof DATE_FORMAT_TYPES];
  ...
  /* ==============================
        User 関連
    ============================== */
  type GetUserDataTypes =
    (typeof GET_USER_DATA_TYPES)[keyof typeof GET_USER_DATA_TYPES];
  type UpdatePasswordPageType =
    (typeof UPDATE_PASSWORD_PAGE_TYPES)[keyof typeof UPDATE_PASSWORD_PAGE_TYPES];
  ...
  /* ==============================
        Product 関連
    ============================== */
  type ProductPriceStatusType =
    (typeof PRODUCT_PRICE_STATUS)[keyof typeof PRODUCT_PRICE_STATUS];
  type ProductCategoryTagType =
    (typeof CATEGORY_TAGS)[keyof typeof CATEGORY_TAGS];
  type ProductStatusSizeType =
    (typeof PRODUCT_STATUS_SIZES)[keyof typeof PRODUCT_STATUS_SIZES];
  type ProductPriceType =
    (typeof PRODUCT_PRICE_TYPES)[keyof typeof PRODUCT_PRICE_TYPES];
  type PriceRangeDraggingType =
    (typeof PRICE_RANGE_DRAGGING_TYPES)[keyof typeof PRICE_RANGE_DRAGGING_TYPES];
  type ProductQuantitySizeType =
    (typeof PRODUCT_QUANTITY_SIZES)[keyof typeof PRODUCT_QUANTITY_SIZES];
  type GetProductsPageType =
    (typeof GET_PRODUCTS_PAGE_TYPES)[keyof typeof GET_PRODUCTS_PAGE_TYPES];
  type OptimalSyncTagType =
    (typeof OPTIMAL_SYNC_TAG_TYPES)[keyof typeof OPTIMAL_SYNC_TAG_TYPES];
  type CollectionSortType =
    (typeof COLLECTION_SORT_TYPES)[keyof typeof COLLECTION_SORT_TYPES];
  type TrendStatusSizeType =
    (typeof TREND_STATUS_SIZES)[keyof typeof TREND_STATUS_SIZES];
  type TrendCategoryType =
    (typeof TREND_CATEGORIES)[keyof typeof TREND_CATEGORIES];
  ...
  type ExcludeProductCategoryTagType = Exclude<
    ProductCategoryTagType,
    typeof ALL_TAG
  >;
  ...
  type ProductSelectFields = Pick<
    Product,
    "title" | "image_urls" | "price" | "category" | "slug"
  >;
  ...
  type CartOperationType =
    (typeof CART_OPERATION_TYPES)[keyof typeof CART_OPERATION_TYPES];
  ...
  /* ==============================
        Review 関連
    ============================== */
  type StarRatingSizeType =
    (typeof STAR_RATING_SIZES_TYPES)[keyof typeof STAR_RATING_SIZES_TYPES];
  type StarRatingType =
    (typeof STAR_RATING_TYPES)[keyof typeof STAR_RATING_TYPES];
  ...
  type OrderDisplayType =
    (typeof ORDER_DISPLAY_TYPES)[keyof typeof ORDER_DISPLAY_TYPES];
  type OrderStatusDisplayType =
    (typeof ORDER_STATUS_DISPLAY_TYPES)[keyof typeof ORDER_STATUS_DISPLAY_TYPES];
  type OrderHistoryCategoryType =
    (typeof ORDER_HISTORY_CATEGORIES)[keyof typeof ORDER_HISTORY_CATEGORIES];
  ...
  interface CreateOrderStripeProps extends Pick<
    OrderStripe,
    "order_id" | "session_id" | "payment_intent_id"
  > {}
  ...
  type StripeSubscriptionIntervalType =
    (typeof STRIPE_SUBSCRIPTION_INTERVALS)[keyof typeof STRIPE_SUBSCRIPTION_INTERVALS];
  type SubscriptionPurchaseType =
    (typeof SUBSCRIPTION_PURCHASE_TYPES)[keyof typeof SUBSCRIPTION_PURCHASE_TYPES];
  type SubscriptionHistoryCategoryType =
    (typeof SUBSCRIPTION_HISTORY_CATEGORIES)[keyof typeof SUBSCRIPTION_HISTORY_CATEGORIES];

  type OrderItemSubscription = PrismaOrderItemSubscription;
  type OrderItemSubscriptionSubscriptionId =
    OrderItemSubscription["subscription_id"];
  ...
  type OrderItemSubscriptionNextPayment =
    OrderItemSubscription["next_payment_date"];
  type OrderItemSubscriptionRemarks = OrderItemSubscription["remarks"];

  type OrderItemSubscriptionSelectFields = Pick<
    OrderItemSubscription,
    "subscription_id" | "status" | "next_payment_date" | "remarks"
  > & {
  ...
  type SubscriptionPaymentSelectFields = Pick<
    SubscriptionPayment,
  ...
  type BookmarkOperationType =
    (typeof BOOKMARK_OPERATION_TYPES)[keyof typeof BOOKMARK_OPERATION_TYPES];
  ...
  /* ==============================
        Sync Log 関連
    ============================== */
  type SyncLogTagSizeType =
    (typeof SYNC_LOG_TAG_SIZES)[keyof typeof SYNC_LOG_TAG_SIZES];
  type SyncLogCategoryType =
    (typeof SYNC_LOG_CATEGORIES)[keyof typeof SYNC_LOG_CATEGORIES];
  ...
  type VerifyEmailType =
    (typeof VERIFY_EMAIL_TYPES)[keyof typeof VERIFY_EMAIL_TYPES];
  type EmailVerificationPageType =
    (typeof EMAIL_VERIFICATION_PAGE_TYPES)[keyof typeof EMAIL_VERIFICATION_PAGE_TYPES];
  type EmailVerificationType =
    (typeof EMAIL_VERIFICATION_TYPES)[keyof typeof EMAIL_VERIFICATION_TYPES];
  type EditEmailStepType =
    (typeof EDIT_EMAIL_STEP)[keyof typeof EDIT_EMAIL_STEP];
  type EditPasswordStepType =
    (typeof EDIT_PASSWORD_STEP)[keyof typeof EDIT_PASSWORD_STEP];

  /* ==============================
        その他
    ============================== */
  type SearchFormSizeType =
    (typeof SEARCH_FORM_SIZES)[keyof typeof SEARCH_FORM_SIZES];
  type ContactStepsType = (typeof CONTACT_STEPS)[keyof typeof CONTACT_STEPS];
  type TextareaSchemaType =
    (typeof TEXTAREA_SCHEMA_TYPES)[keyof typeof TEXTAREA_SCHEMA_TYPES];
  type CloudflareBucketType =
    (typeof CLOUDFLARE_BUCKET_TYPES)[keyof typeof CLOUDFLARE_BUCKET_TYPES];
  type ContactFormStepType =
    (typeof CONTACT_FORM_STEP)[keyof typeof CONTACT_FORM_STEP];
