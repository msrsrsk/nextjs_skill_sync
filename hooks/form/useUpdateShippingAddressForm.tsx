...
import { updateShippingAddressAction } from "@/services/shipping-address/form-actions";
...
const useUpdateShippingAddressForm = (shippingAddresses: ShippingAddress[]) => {
  ...
  const [optimisticOtherAddresses, setOptimisticOtherAddresses] = useState<
    ShippingAddress[]
  >(otherShippingAddresses);
  const [editModalActive, setEditModalActive] = useState(false);
  const [editAddressId, setEditAddressId] = useState<ShippingAddressId | null>(
    null,
  );
