...
const { SYNC_ALL, SYNC_UPDATES, SYNC_VOICES, SYNC_EXTRAS } =
  SYNC_LOG_CATEGORIES;
...
export const categoryLinks = navLinks.filter(
  (link) => link.label === "Category",
);

export const trendLinks = navLinks.filter((link) => link.label === "Trend");

export const syncLogLinks = navLinks.filter(
  (link) => link.label === "The Sync Log",
);
...
export const categorySectionLinks = [
  {
    ...
    imageBoxClassName:
      "w-[186px] xl:w-[255px] -top-[10px] -right-[26px] lg-xl:-top-[4px] lg-xl:-right-[38px]",
  },
  {
    ...
    imageBoxClassName:
      "w-[180px] xl:w-[242px] -top-[17px] -right-[13px] lg-xl:-top-[25px] lg-xl:-right-[20px]",
  },
  {
    title: UNIQUE_SKILLS,
    ...
    imageBoxClassName:
      "w-[161px] xl:w-[251px] top-[2px] right-[7px] lg-xl:top-auto lg-xl:right-auto lg-xl:bottom-[114px] lg-xl:-left-[33px]",
  ...
  },
  {
    ...
    imageBoxClassName:
      "w-[181px] xl:w-[271px] -top-[14px] -right-[13px] lg-xl:-top-[19px] lg-xl:-right-[24px]",
  },
  {
    title: WISDOM_SKILLS,
    ...
    imageBoxClassName:
      "w-[183px] xl:w-[254px] -top-[15px] -right-[18px] lg-xl:-top-[19px] lg-xl:-right-[36px]",
  },
];

export const footerLinks = navLinks.filter(
  (link) => link.label === "Category" || link.label === "The Sync Log",
);
